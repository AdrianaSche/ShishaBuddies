...
public class SwaggerConfig {
    ...
    public Docket api() {
        return new Docket(DocumentationType.SWAGGER_2)
                ...
                .select()
                .apis(RequestHandlerSelectors.basePackage("de.adrianaschepers.shishabuddies"))
    ...
    private ApiInfo getApiInfo() {
        return new ApiInfoBuilder()
                .title("ShishaBuddies Karma Swagger 2021")
                .description("Sources at: https://github.com/AdrianaSche/ShishaBuddies")
                .version("1.0")
                .build();
    }
}
